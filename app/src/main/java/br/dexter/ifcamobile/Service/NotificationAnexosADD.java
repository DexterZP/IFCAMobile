...
public class NotificationAnexosADD extends BroadcastReceiver
{
    private static final String BaseAction = "br.dexter.ifcamobile";
    private DatabaseReference databaseReference;

    public NotificationAnexosADD() { }
    ...
    private void StartYourService(@NonNull final Context context)
    {
        ...
        databaseReference.child(GetCodigo(context)).child(context.getResources().getString(R.string.DatabaseName)).child("Last Path").addChildEventListener(new ChildEventListener()
        {
            @Override
            ...
            public void onChildChanged(@NonNull DataSnapshot dataSnapshot, @Nullable String s)
            {
                ...
                if(notificationManager != null)
                {
                    ...
                    notificationBuilder.setAutoCancel(true)
                            ...
                            .setContentTitle("Anexos")
                            .setColor(ContextCompat.getColor(context, R.color.azure))
                            .setContentText("Um novo arquivo foi enviado para a sua turma")
                            .setAutoCancel(true);

                    PendingIntent pendingIntent = PendingIntent.getActivity(context, 2, new Intent(context, Anexos.class), PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    public static void enableBootReceiver(Context context) {
        ComponentName receiver = new ComponentName(context, NotificationAnexosADD.class);
    ...
    public static void startBaseAlarmManager(@NonNull Context context)
    {
        ...
        Intent intent = new Intent(context, NotificationAnexosADD.class);
        intent.setAction(BaseAction);

        PendingIntent alarmIntent = PendingIntent.getBroadcast(context, 2, intent, PendingIntent.FLAG_UPDATE_CURRENT);
